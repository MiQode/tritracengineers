                    ...
                    <div className="col-xl-2 offset-xl-1 col-lg-3 col-md-4">
                      ...
                      <div className="footer-widget mb-0">
                        ...
                        <div className="footer-widget__content">
                          <p className="address">P.O.BOX 126075, Kampala</p>
                          <ul className="contact-details">
                            <li>
                              <span>P:</span>+256752017044 / +256773527950
                            </li>
                            <li>
                              <span>E:</span>Tritracengineersltd@gmail.com
                            </li>
                          </ul>
                        </div>
                      </div>
          ...
          <div className="footer-copyright-wrapper">
            <div className="footer-copyright text-center">
              <p className="copyright-text">
                &copy; Tritrac {new Date().getFullYear()} Designed with{' '}
                <i className="fa fa-heart"></i>{' '}
                <a href="https://mike-rembo.vercel.app/" target="blank">
                  By Mike
                </a>
              </p>
            </div>
